...
public class MeshBatcher
{
        ...
        int atlas = 0)
    {
        ...
        // Record command using the currently bound shader
        var shader = Render.CurrentShader;
        ...
        _vertices[_vertexWriteOffset + 0] = new MeshVertex { Position = p0, UV = new Vector2(u0, v0), Normal = Vector2.Zero, Color = color, Opacity = 1.0f, Bone = 0, Atlas = atlas, FrameCount = 1, FrameWidth = 0, FrameRate = 0, AnimStartTime = 0 };
        _vertices[_vertexWriteOffset + 1] = new MeshVertex { Position = p1, UV = new Vector2(u1, v0), Normal = Vector2.Zero, Color = color, Opacity = 1.0f, Bone = 0, Atlas = atlas, FrameCount = 1, FrameWidth = 0, FrameRate = 0, AnimStartTime = 0 };
        _vertices[_vertexWriteOffset + 2] = new MeshVertex { Position = p2, UV = new Vector2(u1, v1), Normal = Vector2.Zero, Color = color, Opacity = 1.0f, Bone = 0, Atlas = atlas, FrameCount = 1, FrameWidth = 0, FrameRate = 0, AnimStartTime = 0 };
        _vertices[_vertexWriteOffset + 3] = new MeshVertex { Position = p3, UV = new Vector2(u0, v1), Normal = Vector2.Zero, Color = color, Opacity = 1.0f, Bone = 0, Atlas = atlas, FrameCount = 1, FrameWidth = 0, FrameRate = 0, AnimStartTime = 0 };
        ...
        Color32 tint)
    {
        ...
        for (int i = 0; i < vertices.Length; i++)
        {
            ...
            dst.AnimStartTime = src.AnimStartTime;
        }
